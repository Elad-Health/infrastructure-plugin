---
name: disk-space
description: Analyze disk space across SQL Server infrastructure. Uses architecture-aware optimization to minimize token usage while providing comprehensive drive analysis.
user-invocable: true
